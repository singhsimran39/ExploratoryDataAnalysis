...
Notes:Cross sectional data does not enable us to study a variable over a over different values of a different variable

***

### Scatterplot Matrix
Notes: Here we create plots for each pair of the variables in the pf data set. The plots are below the diagonal and the correlation is above the diagonal.
```{r}
...
### Heat Maps
Notes:We plot a heat map for genome data. Here we have only selected 200 out of about 6000 genes.
